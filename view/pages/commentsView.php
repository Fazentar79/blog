                        ...
                        <section class="w-50 d-block m-auto">
                            ...
                            <form action="add-comment" method="post">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="comment_pseudo" name="comment_pseudo"
                                ...
                                <button type="submit" class="btn btn-outline-secondary"
                                        name="submit_comment">Publier</button>
                            </form>
                            ...
                            if ($_SESSION['pseudo'] === $comment['comment_pseudo'] || $_SESSION['role'] === 1) { ?>
                                <div class="d-flex justify-content-md-start justify-content-between">
                                    <button type="button" class="btn btn-outline-secondary"
                                            data-bs-toggle="modal" data-bs-target="#modify_comment">
                                        Modifier le commentaire
                                    </button>
                                    <button type="button" class="btn btn-outline-danger ms-3"
                                            data-bs-toggle="modal" data-bs-target="#suppress_comment">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="modify-comment" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <textarea class="form-control" id="modify_UserComment"
                                                                  name="modify_UserComment" rows="3"
                                                    ...
                                                    <div class="modal-footer">
                                                        <input type="submit" class="btn btn-outline-secondary"
                                                               name="modify_comment" value="Modifier">
                                    ...
                                    <div class="modal fade" id="suppress_comment" data-bs-backdrop="static">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="m-0">
                                                        Etes-vous sûr de vous de vouloir supprimer le commentaire ?
                                                    </p>
                                                </div>
                                                ...
                                                <div class="modal-footer">
                                                    <form action="delete-comment" method="post" class="my-3 ms-md-5">
                                                        <input type="submit" class="btn btn-outline-danger"
                                                               name="delete_comment" value="Supprimer le commentaire">
                                                        <input type="hidden" name="id_comment"
                                                               value="<?= $comment['id'] ?>">
                                                    </form>
                                                    <button type="button" class="btn btn-outline-secondary"
                    ...
                    <div class="container d-flex flex-column">
                        <div class="m-auto">
                            <p class="mt-5">Tu dois être connecté pour accéder à cette page. <br><br>
                                Si tu n'as pas de compte ou que tu as oublié de te connecter,
                                 clic sur le lien ci-dessous :</p><br>
